      ...
      <div className="container">
        <div className="cols">
          ...
          <div>
            ...
            <div className='socialIcon'><a href='https://www.facebook.com/orionaguaquimica?locale=pt_BR'><img src='../../public/imagens/icones/face.png'/></a></div>
            <div className='socialIcon'><a href='https://www.instagram.com/orionaguaquimica/'><img src='../../public/imagens/icones/instagram.svg' /></a></div>
            </div>
          </div>
        </div>
      </div>
