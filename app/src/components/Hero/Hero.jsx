          ...
          <div className="grid">
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <div className="whatsBtn">
                <Button icon={'../../../../dist/assets/imagens/icones/Home_branco.png'} link={'/servicos'} title='Nossos Serviços' ></Button>
              </div>
              <div className="whatsBtn">
                <Button icon={'../../../../dist/assets/imagens/icones/whats.png'} link={'https://wa.me/+556530231011'} title='WhatsApp' ></Button>
              </div>
            </div>
          </div>
        </div>
